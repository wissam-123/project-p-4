...
<header class="header">
    ...
    <main class="content">
       ...
       <p> Mijn naam is Wissam Hatat, Ik hou heel veel van sport, ik ben social en vriendelijk.
        <br>
        Ik ben leergerig en ik heb altijd behoefte aan nieuwe dingen te leren
       </p>
    </main>
